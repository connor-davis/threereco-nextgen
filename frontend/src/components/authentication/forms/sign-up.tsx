...
import { zRegisterPayload } from '@/api-client/zod.gen';
...
export function SignUpForm({
  ...
  const signUpForm = useForm<z.infer<typeof zRegisterPayload>>({
    resolver: zodResolver(zRegisterPayload),
    defaultValues: {
      name: '',
      username: '',
      password: '',
